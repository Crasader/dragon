APPNAME="DragonBattle"
APP_ANDROID_NAME="com.wonpee.battle"
...
echo "stop ${APP_ANDROID_NAME}"
adb shell am force-stop "${APP_ANDROID_NAME}"

echo "set NDK_MODULE_PATH"

NDK_MODULE_PATH="${COCOS2DX_ROOT}":"${COCOS2DX_ROOT}"/external:"${COCOS2DX_ROOT}"/cocos2dx/platform/third_party/android/prebuilt \

echo "NDK_ROOT = ${NDK_ROOT}/ndk-gdb"
